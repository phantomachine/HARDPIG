...
classdef ksmod03ss < handle
    ...
    properties
        ...
        Nagrid = 5;  % No. of grid points for AGRID 
        Nbgrid = 6; % No. grid points for each b(i), i = -N,...,-1,1,...,M 
    ...
    methods
        function self = ksmod03ss(SIGMA,PHI,M,N,WAGE,REP_RATIO,DELTA)
            % KSMOD02: 
        ...
        function [v, a] = howard(self,taxtrans)
            ...
            a = self.ProfileSetA(2)*ones(1,nstate);
