function [Cnew, lambda_new, w_new ] = admit_outer_lpset_ramsey(self,...
                                              PolyTriIndex,Fset,H,C,P_a,...
...
%                                    lambda*Util_now - pival_k ]; ... (3)
                        ...
                        [wmin,fmax,status,~] = glpk( objective,...
                                                    constraint,...
                                                    bconstraint,...
                                                    lb_local,ub_local,...
                                                    ctype_local,...
                        ...
                        if status == 2    
                            status_vec(n) = status; 
                            val = h*Util_now + fmax; % Add current payoff
                    ...
                    %cplus_j_temp(j) = max(cplus_n_temp);
            ...
            %cplus_a_temp_local(index_a) = max(cplus_j_temp); 
                                                    % c+[k,l,(a,b)]
