...
classdef ksmod04 < handle
    ...
    properties
        ...
        Nbgrid = 4; % No. grid points for each b(i), i = -N,...,-1,1,...,M 
    ...
    methods
        function self = ksmod04(SIGMA,PHI,M,N,WAGE,REP_RATIO,DELTA)
            % KSMOD02: 
            ...
            b_u = linspace(0.4,self.MBAR,self.Nbgrid)';
