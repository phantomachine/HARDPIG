function vG_ramsey = ramsey_extreme(C_old, np, V_MAX, V_MIN)

% RAMSEY_EXTREME.M
% Compute boundaries (min and max) total expected payoffs given (C_old, H)
% from running RAMSEY routine in RAMSEY.M
%
% T.Kam, 2011

% Load results from RAMSEY.M
% load(strcat('_mat/', mat_filename))
