% Random_polygonfill.m
%
% From: http://www.mathworks.com/matlabcentral/newsreader/view_thread/170480
%
% Roger Stafford

%clear
n = 500; % <-- Choose the desired number of points, preferably large
...
% p = (1-s)*p1 + s2.*((1-t2).*pa + t2.*pb); % The random points
% 
% c = [p1;p2;p3;p4;p1]; % Plot the pentagon in red
% 
% figure
% plot(c(:,1),c(:,2),'ro',c(:,1),c(:,2),'r-',...
%      p(:,1),p(:,2),'y.') % Plot random points as yellow dots
